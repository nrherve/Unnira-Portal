...
const Login: React.FC = () => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (data.email === 'admin@unnira.com' && data.password === 'admin123' && data.role === 'admin') {
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div className="text-xs text-blue-700 space-y-1">
              <p><strong>Admin:</strong> admin@unnira.com / admin123</p>
              <p><strong>Student:</strong> Any email / Any password (6+ chars)</p>
              <p><strong>Employer:</strong> Any email / Any password (6+ chars)</p>
            </div>
          </div>
        </div>
      </main>
